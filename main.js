...
/***/ "./modules/images/reaper_collapsed_OSL.data.png":
/*!******************************************************!*\
  !*** ./modules/images/reaper_collapsed_OSL.data.png ***!
  \******************************************************/
...
/***/ "./modules/images/reaper_collapsed_RS3.data.png":
/*!******************************************************!*\
  !*** ./modules/images/reaper_collapsed_RS3.data.png ***!
  \******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./modules/images/reaper_expanded_OSL.data.png":
/*!*****************************************************!*\
  !*** ./modules/images/reaper_expanded_OSL.data.png ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./modules/images/reaper_expanded_RS3.data.png":
/*!*****************************************************!*\
  !*** ./modules/images/reaper_expanded_RS3.data.png ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./modules/images/slayer_collapsed_OSL.data.png":
/*!******************************************************!*\
  !*** ./modules/images/slayer_collapsed_OSL.data.png ***!
  \******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./modules/images/slayer_collapsed_RS3.data.png":
/*!******************************************************!*\
  !*** ./modules/images/slayer_collapsed_RS3.data.png ***!
  \******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./modules/images/slayer_expanded_OSL.data.png":
/*!*****************************************************!*\
  !*** ./modules/images/slayer_expanded_OSL.data.png ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
/***/ "./modules/images/slayer_expanded_RS3.data.png":
/*!*****************************************************!*\
  !*** ./modules/images/slayer_expanded_RS3.data.png ***!
  \*****************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
function assignmentWikiPreview(side) {
    document.getElementById("preview-task-wiki-" + side).style.visibility = "hidden";
}
// Hide the specific Creature's preview wiki page
function creatureWikiPreview(side) {
    document.getElementById("preview-creature-wiki-" + side).style.visibility = "hidden";
}
// Hide more Equipment for task
function moreEquip(side) {
    document.getElementById("equipHidden-" + side).style.visibility = "hidden";
}
// Hide more Locations for task
function moreLocations(side) {
    document.getElementById("locationHidden-" + side).style.visibility = "hidden";
}
...
/* harmony import */ var _data_reapers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/reapers */ "./modules/data/reapers.ts");
/* harmony import */ var _data_assignments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../data/assignments */ "./modules/data/assignments.ts");
...
(function (set) {
    ...
    function suggested() {
        if (suggestedLoaded)
            return;
        // TODO setup suggested tasks doc
        suggestedLoaded = true;
    }
    set.suggested = suggested;
    // Set search button
    function searchButtonText(s) {
        document.getElementById("search-button").innerHTML = s + "<span style=\"visibility: hidden;\">. . .</span>";
    }
    ...
    function searchInput(s) {
        if (s == null)
            return;
        document.getElementById("search-info").value = s;
...
(function (get) {
    ...
    function searchInput() {
        return document.getElementById("search-info").value;
    }
...
(function (setup) {
    ...
    function documentMain() {
        ...
        document.getElementById("search-info").addEventListener('keyup', function (event) {
            switch (event.key) {
                case "ArrowUp":
                    _dochandler__WEBPACK_IMPORTED_MODULE_0__.main.set.searchInput(_slayer__WEBPACK_IMPORTED_MODULE_1__.getPreviousSearchHistory());
                    break;
                case "ArrowDown":
                    _dochandler__WEBPACK_IMPORTED_MODULE_0__.main.set.searchInput(_slayer__WEBPACK_IMPORTED_MODULE_1__.getNextSearchHistory());
                    break;
                case "Enter":
                    _slayer__WEBPACK_IMPORTED_MODULE_1__.searchTasks();
                    break;
            }
        });
    ...
    function doubleAssignment() {
        ...
        var _loop_1 = function (side) {
            ...
            document.getElementById("equipMore-" + side).addEventListener('mouseenter', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hover.moreEquip(side); });
            document.getElementById("equipHidden-" + side).addEventListener('mouseleave', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hide.moreEquip(side); });
            document.getElementById("locationMore-" + side).addEventListener('mouseenter', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hover.moreLocations(side); });
            document.getElementById("locationHidden-" + side).addEventListener('mouseleave', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hide.moreLocations(side); });
            document.getElementById("creature-wiki-" + side).addEventListener('click', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.open.wiki.creature(side); });
            document.getElementById("creature-wiki-" + side).addEventListener('mouseover', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hover.creatureWiki(side); });
    ...
    function singleAssignment(side) {
        document.getElementById("base").innerHTML = getExampleSingle(side);
        document.getElementById("task-wiki-" + side).addEventListener('click', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.open.wiki.assignment(side); });
        document.getElementById("task-wiki-" + side).addEventListener('mouseover', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hover.assignmentWiki(side); });
        document.getElementById("preview-task-wiki-" + side).addEventListener('mouseleave', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hide.assignmentWikiPreview(side); });
        document.getElementById("equipMore-" + side).addEventListener('mouseenter', function () { _dochandler__WEBPACK_IMPORTED_MODULE_0__.hover.moreEquip(side); });
...
var toggle;
(function (toggle) {
    // Toggle if we are capturing screen or searching
    function searchText() {
    ...
    function singleDouble(side) {
        ...
        if (doubleLoaded = !doubleLoaded)
            ...
            setup.singleAssignment(side);
    }
    toggle.singleDouble = singleDouble;
})(toggle || (toggle = {}));
...
function aboutInfo() {
    window.open("./about.html", null, "width=480,height=550");
}
...
function assignmentWikiPreview(side) {
    document.getElementById("preview-task-wiki-" + side).style.visibility = "visible";
}
// Show the specific Creature's preview wiki page
function creatureWikiPreview(side) {
    document.getElementById("preview-creature-wiki-" + side).style.visibility = "visible";
}
// Show more Equipment for task
function moreEquip(side) {
    if (document.getElementById("equipHidden-" + side).innerHTML != null && document.getElementById("equipHidden-" + side).innerHTML.trimEnd() != "")
        document.getElementById("equipHidden-" + side).style.visibility = "visible";
}
// Show more Locations for task
function moreLocations(side) {
    if (document.getElementById("locationHidden-" + side).innerHTML != null && document.getElementById("locationHidden-" + side).innerHTML.trimEnd() != "")
        document.getElementById("locationHidden-" + side).style.visibility = "visible";
}
...
/* harmony export */   getNextSearchHistory: () => (/* binding */ getNextSearchHistory),
/* harmony export */   getPreviousSearchHistory: () => (/* binding */ getPreviousSearchHistory),
...
/* harmony import */ var alt1_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! alt1/dialog */ "../node_modules/alt1/dist/dialog/index.js");
/* harmony import */ var alt1_dialog__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(alt1_dialog__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var alt1_ocr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! alt1/ocr */ "../node_modules/alt1/dist/ocr/index.js");
/* harmony import */ var alt1_ocr__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(alt1_ocr__WEBPACK_IMPORTED_MODULE_5__);
...
var imgs = alt1__WEBPACK_IMPORTED_MODULE_3__.webpackImages({
    ...
    reaper_expanded_OSL: __webpack_require__(/*! ./images/reaper_expanded_OSL.data.png */ "./modules/images/reaper_expanded_OSL.data.png"),
    slayer_collapsed_RS3: __webpack_require__(/*! ./images/slayer_collapsed_RS3.data.png */ "./modules/images/slayer_collapsed_RS3.data.png"),
    slayer_collapsed_OSL: __webpack_require__(/*! ./images/slayer_collapsed_OSL.data.png */ "./modules/images/slayer_collapsed_OSL.data.png"),
...
function captureRunescape() {
    if (!canCaptureRunescape())
        return null;
    try {
        return alt1__WEBPACK_IMPORTED_MODULE_3__.captureHoldFullRs();
    }
    catch (ex) {
...
function getPreviousSearchHistory() {
    ...
    if (searchIndex == searchHistory.length && tempSearch != document.getElementById("search-info").value)
        tempSearch = document.getElementById("search-info").value;
    // Setup temp search value if new entry is added
    if (searchIndex == searchHistory.length + 1 && document.getElementById("search-info").value != "") {
        tempSearch = document.getElementById("search-info").value;
        --searchIndex;
    }
    if (searchIndex - 1 < 0)
...
function getNextSearchHistory() {
    ...
    if (searchIndex + 1 > searchHistory.length + (tempSearch == "" ? 0 : 1))
        return null;
    if (++searchIndex == searchHistory.length + (tempSearch == "" ? 0 : 1))
        return "";
    if (tempSearch != "" && searchIndex == searchHistory.length)
        return tempSearch;
    return searchHistory[searchIndex];
}
...
function findSlayerRS3UI(img) {
    ...
    if (!data && loc.length > 0)
        data = { collapsed: true, OS: true, img: imgs.slayer_collapsed_OSL };
    // Look for OS Expanded Salyer Counter
    if (!data)
        loc = img.findSubimage(imgs.slayer_expanded_OSL);
    if (!data && loc.length > 0)
        data = { collapsed: false, OS: true, img: imgs.slayer_expanded_OSL };
    // Look for RS3 Collapsed Salyer Counter
    if (!data)
        loc = img.findSubimage(imgs.slayer_collapsed_RS3);
    if (!data && loc.length > 0)
        data = { collapsed: true, OS: false, img: imgs.slayer_collapsed_RS3 };
    // Look for RS3 Expanded Salyer Counter
    if (!data)
        loc = img.findSubimage(imgs.slayer_expanded_RS3);
    if (!data && loc.length > 0)
        data = { collapsed: false, OS: false, img: imgs.slayer_expanded_RS3 };
...
function findReaperRS3UI(img) {
    ...
    if (!data && loc.length > 0)
        data = { collapsed: true, OS: true, img: imgs.reaper_collapsed_OSL };
    // Look for OS Expanded Reaper Counter
    if (!data)
        loc = img.findSubimage(imgs.reaper_expanded_OSL);
    if (!data && loc.length > 0)
        data = { collapsed: false, OS: true, img: imgs.reaper_expanded_OSL };
    // Look for RS3 Collapsed Reaper Counter
    if (!data)
        loc = img.findSubimage(imgs.reaper_collapsed_RS3);
    if (!data && loc.length > 0)
        data = { collapsed: true, OS: false, img: imgs.reaper_collapsed_RS3 };
    // Look for RS3 Expanded Reaper Counter
    if (!data)
        loc = img.findSubimage(imgs.reaper_expanded_RS3);
    if (!data && loc.length > 0)
        data = { collapsed: false, OS: false, img: imgs.reaper_expanded_RS3 };
    // If we don't find any data or we found too many matches then return
    if (!data || loc.length == 0)
        return false;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   assignments: () => (/* reexport module object */ _modules_data_assignments__WEBPACK_IMPORTED_MODULE_7__),
/* harmony export */   captureLoop: () => (/* binding */ captureLoop),
/* harmony export */   creatures: () => (/* reexport module object */ _modules_data_creatures__WEBPACK_IMPORTED_MODULE_8__),
/* harmony export */   dochandler: () => (/* reexport module object */ _modules_dochandler__WEBPACK_IMPORTED_MODULE_2__),
/* harmony export */   extrafuncs: () => (/* reexport module object */ _modules_extrafuncs__WEBPACK_IMPORTED_MODULE_4__),
/* harmony export */   masters: () => (/* reexport module object */ _modules_data_masters__WEBPACK_IMPORTED_MODULE_5__),
/* harmony export */   reapers: () => (/* reexport module object */ _modules_data_reapers__WEBPACK_IMPORTED_MODULE_6__),
/* harmony export */   settings: () => (/* reexport module object */ _modules_settings__WEBPACK_IMPORTED_MODULE_0__),
/* harmony export */   slayer: () => (/* reexport module object */ _modules_slayer__WEBPACK_IMPORTED_MODULE_1__),
/* harmony export */   variants: () => (/* reexport module object */ _modules_data_variants__WEBPACK_IMPORTED_MODULE_9__)
/* harmony export */ });
...
/* harmony import */ var _modules_extrafuncs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/extrafuncs */ "./modules/extrafuncs.ts");
/* harmony import */ var _modules_data_masters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/data/masters */ "./modules/data/masters.ts");
/* harmony import */ var _modules_data_reapers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/data/reapers */ "./modules/data/reapers.ts");
...
// Export everything so the website can use it
...
/*
    ...
    Ability to keep track of previous X tasks
    Add ability to find current reaper/slayer task based on the GUI for it (needs ability to read task now)

    ~ Near future Release ~
    Add support for Ushabti
    Add support for 120 Slayer Tasks Chooser (Detection added just need to add suggetions list now)
    Adjust the lookNfeel of the app to better work with resizing the app
